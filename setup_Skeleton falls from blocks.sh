...
# Параметры
BUNDLE_ID="com.skeletonfall.play"
APPLE_ID="6756483838"
REMOTE_URL="git@github.com:sdeslvm/Skeleton-falls-from-blocks.git"
PROJECT_NAME="Skeleton falls from blocks"
SCHEME_NAME="Skeleton falls from blocks"
