...
final class SkeletonFallsBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: SkeletonFallsWebLoader
    private let coordinator: SkeletonFallsWebCoordinator
    ...
    init(
        ...
        loader: SkeletonFallsWebLoader,
        coordinator: SkeletonFallsWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        SkeletonFallsOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        SkeletonFallsOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        SkeletonFallsOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension SkeletonFallsBaseWebViewController {
