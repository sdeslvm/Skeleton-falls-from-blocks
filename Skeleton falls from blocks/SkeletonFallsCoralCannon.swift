...
class SkeletonFallsWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (SkeletonFallsWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (SkeletonFallsWebStatus) -> Void) {
