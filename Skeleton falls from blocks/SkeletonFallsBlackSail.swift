...
enum SkeletonFallsWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: SkeletonFallsWebStatus) -> Bool {
        switch (self, other) {
...
extension SkeletonFallsWebStatus {
...
extension SkeletonFallsWebStatus {
    static func == (lhs: SkeletonFallsWebStatus, rhs: SkeletonFallsWebStatus) -> Bool {
